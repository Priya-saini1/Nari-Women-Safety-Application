package com.example.nari_app.Contact;
...
public class CustomAdapter extends ArrayAdapter<ContactModel>{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ContactModel c = getItem(position);
          if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.activity_user_items_sos, parent, false);
        }
        ...
        TextView tvPhone = (TextView) convertView.findViewById(R.id.textView);
